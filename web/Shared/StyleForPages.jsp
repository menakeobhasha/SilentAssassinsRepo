<%-- 
    Document   : StyleForPages
    Created on : Jun 17, 2018, 1:21:21 PM
    Author     : Menake
--%>
...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="../plugins/iCheck/flat/blue.css" type="text/css">
        <!-- Morris chart -->
        <link rel="stylesheet" href="../plugins/morris/morris.css" type="text/css">
        <!-- jvectormap -->
        <link rel="stylesheet" href="../plugins/jvectormap/jquery-jvectormap-1.2.2.css" type="text/css">
        <!-- Date Picker -->
